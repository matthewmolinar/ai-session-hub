  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
      ...
      >
        ...
        {ticks(254, 72, 12, 0.07)}
        {ticks(254, 12, 18, 0.14)}
        ...
        {[0, 45, 90, 135].map((deg) => {
          ...
          return (
            <line key={deg}
              ...
              stroke={`${deg % 90 === 0 ? purple : pink} / ${deg % 90 === 0 ? 0.07 : 0.04})`}
              strokeWidth="0.5"
          ...
          return (
            <g key={`d-${deg}`}>
              <rect x={x - 4} y={y - 4} width={8} height={8}
                ...
                fill="none" stroke={`${purple} / 0.18)`} strokeWidth="0.75" />
              <circle cx={x} cy={y} r={2} fill={`${purple} / 0.14)`} />
            </g>
          );
        })}
        ...
        {[45, 135, 225, 315].map((deg) => {
          ...
          return (
            <circle key={`c-${deg}`} cx={x} cy={y} r={3}
              fill="none" stroke={`${pink} / 0.14)`} strokeWidth="0.75" />
          );
        })}
        ...
        {(() => {
          ...
          return <polygon points={pts} fill="none" stroke={`${pink} / 0.05)`} strokeWidth="0.75"
            strokeDasharray="4 8" />;
        })()}
        ...
        {(() => {
          ...
          return <polygon points={pts} fill="none" stroke={`${purple} / 0.035)`} strokeWidth="0.75"
            strokeDasharray="4 8" />;
        })()}
      </motion.svg>
    </div>
